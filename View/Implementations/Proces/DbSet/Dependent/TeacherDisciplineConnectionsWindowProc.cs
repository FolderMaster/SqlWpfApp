...
namespace View.Implementations.Proces.DbSet.Dependent
{
    ...
    public class TeacherDisciplineConnectionsWindowProc : WindowProc
    {
        ...
        public TeacherDisciplineConnectionsWindowProc(IDbContextBuilder dbContextBuilder,
        ...
        protected override Window CreateWindow(IDbContextBuilder dbContextBuilder,
            IWindowResourceService windowResourceService, IMessageService messageService) =>
            new TeacherDisciplineConnectionsWindow(dbContextBuilder, windowResourceService,
                messageService);
    }
}